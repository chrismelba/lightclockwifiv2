...
const char* html = "<html><head><style></style></head><body><form action='/' method='GET'>"
                    "<input type='color' name='hourcolor' value='$hourcolor'/><input type='color' name='minutecolor' value='$minutecolor'/><input type='submit' name='submit' value='Update RGB Strip'/>"
